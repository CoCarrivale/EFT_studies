...
echo "Downloading MG5_aMC_v2_9_23..."
wget http://cms-project-generators.web.cern.ch/cms-project-generators/MG5_aMC_v2_9_23.tar.gz
tar xvf MG5_aMC_v2_9_23.tar.gz
rm MG5_aMC_v2_9_23.tar.gz
